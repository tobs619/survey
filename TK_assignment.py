...
client_1e2c40193e164401b933cb1bbb7acfd7 = ibm_boto3.client(service_name='s3',
    ibm_api_key_id='VeIxQoVHTdAdIFnNyI0gbTfxvh3V2ci6QwIoSuGF9WnQ',
    ibm_auth_endpoint="https://iam.cloud.ibm.com/oidc/token",
    config=Config(signature_version='oauth'),
    endpoint_url='https://s3.private.us.cloud-object-storage.appdomain.cloud')

streaming_body_1 = client_1e2c40193e164401b933cb1bbb7acfd7.get_object(Bucket='capstoneproject-donotdelete-pr-fiwivycui0ewwr', Key='Collecting_Jobs_data_Using_API-Questions.ipynb')['Body']
...
credentials_1 = {
    'IAM_SERVICE_ID': 'iam-ServiceId-a96b9618-dab0-48d3-b0f6-18a60a73bc9d',
    'IBM_API_KEY_ID': 'VeIxQoVHTdAdIFnNyI0gbTfxvh3V2ci6QwIoSuGF9WnQ',
    'ENDPOINT': 'https://s3.private.us.cloud-object-storage.appdomain.cloud',
    'IBM_AUTH_ENDPOINT': 'https://iam.cloud.ibm.com/oidc/token',
    'BUCKET': 'capstoneproject-donotdelete-pr-fiwivycui0ewwr',
    'FILE': 'Collecting_Jobs_data_Using_API-Questions.ipynb'
}
...
appi_url="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DA0321EN-SkillsNetwork/labs/module%201/Accessing%20Data%20Using%20APIs/jobs.json?utm_medium=Exinfluencer&utm_source=Exinfluencer&utm_content=000026UJ&utm_term=10006555&utm_id=NA-SkillsNetwork-Channel-SkillsNetworkCoursesIBMDA0321ENSkillsNetwork21426264-2022-01-01"
response = requests.get(appi_url) # Call the API using the get method and store the
                                # output of the API call in a variable called response.
if response.ok:             # if all is well() no errors, no network timeouts)
    data = response.json() 
...
tk_data=pd.read_json('https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DA0321EN-SkillsNetwork/labs/module%201/Accessing%20Data%20Using%20APIs/jobs.json?utm_medium=Exinfluencer&utm_source=Exinfluencer&utm_content=000026UJ&utm_term=10006555&utm_id=NA-SkillsNetwork-Channel-SkillsNetworkCoursesIBMDA0321ENSkillsNetwork21426264-2022-01-01')
...
def get_number_of_jobs_L(location):
    ...
    len(location) as number_of_jobs
